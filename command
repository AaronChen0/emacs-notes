...
'M-x replace-regexp':use '\?'in the replacement string if you want to enter part of the replacement string by hand each time.
...
'C-x C-v':find alternative file M-; M-@(mark-word)
...
M-=(count-words-regoin) M-h(mark-paragraph)
...
'C-<<space>'='C-@'='S-C-n'  'C-x C-x':move to the other end of the region
...
You can also supply <<F4> with a numeric prefix argument ‘n’, which means to
invoke the macro ‘n’ times.
...
(string-match <x-color><param>VioletRed4</param>"GNU"</x-color> <x-color><param>VioletRed4</param>"GNo"</x-color>)
(message <x-color><param>VioletRed4</param>"I love you, JiaSheng"</x-color>)
